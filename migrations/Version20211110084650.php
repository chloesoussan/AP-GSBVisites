 ...
 */
final class Version20211110084650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medecin (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, specialite_complementaire VARCHAR(255) DEFAULT NULL, departement INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offrir (medicament_id VARCHAR(255) NOT NULL, rapport_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_1D1E4ADEAB0D61F7 (medicament_id), INDEX IDX_1D1E4ADE1DFBCC46 (rapport_id), PRIMARY KEY(medicament_id, rapport_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rapport (id INT AUTO_INCREMENT NOT NULL, medecin_id INT NOT NULL, visiteur_id VARCHAR(255) NOT NULL, date DATE DEFAULT NULL, motif VARCHAR(255) DEFAULT NULL, bilan VARCHAR(255) DEFAULT NULL, INDEX IDX_BE34A09C4F31A84 (medecin_id), INDEX IDX_BE34A09C7F72333D (visiteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
